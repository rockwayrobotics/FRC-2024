...
import frc.robot.commands.TeleopReset;
...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    new TeleopReset(m_robotContainer.m_drivebase, m_robotContainer.m_intake, m_robotContainer.m_shooter, m_robotContainer.m_led).schedule();
