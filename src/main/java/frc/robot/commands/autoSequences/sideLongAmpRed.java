 ...
 */
public class sideLongAmpRed extends SequentialCommandGroup {
    ...
    public sideLongAmpRed(DrivebaseSubsystem drivebase, ShooterSubsystem shooter, IntakeSubsystem intake, LedSubsystem led, double waittime){
