 ...
 */
public class sideThreePieceRed extends SequentialCommandGroup {
    ...
    public sideThreePieceRed(DrivebaseSubsystem drivebase, ShooterSubsystem shooter, IntakeSubsystem intake, LedSubsystem led, double waittime){
        ...
        FailFastTimeoutGroup sequence = new FailFastTimeoutGroup()
                ...
                .then(new ShootFromGroundDriveRotateFour(m_shooter, m_intake, m_led, m_drivebase, 1.1, 50))
                
                .then(new DriveDistance(m_drivebase, -0.5, 0.1))
                .then(new DriveRotate(m_drivebase, -80))
                ...
                .then(new ShootFromGroundDriveFour(shooter, intake, led, drivebase, 1))
