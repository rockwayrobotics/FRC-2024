 ...
 */
public class sideLongSourceBlue extends SequentialCommandGroup {
    ...
    public sideLongSourceBlue(DrivebaseSubsystem drivebase, ShooterSubsystem shooter, IntakeSubsystem intake, LedSubsystem led, double waittime){
        ...
        FailFastTimeoutGroup sequence = new FailFastTimeoutGroup()
                ...
                .then(new DriveDistance(m_drivebase, -0.5, 3.3))
                ...
                .then(new DriveDistance(m_drivebase, -0.5, 4.5))

                .then(new ShootFromGroundDriveRotateAdjust(m_shooter, m_intake, m_led, m_drivebase, 1, 25, 6.5))
